...
<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <button  onclick="window.location.href='/auth/google';" class="flex items-center justify-center mt-5 bg-white dark:bg-gray-900 border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 w-full">
