...
<head>
    ...
    <title>Website cờ bạc hàng đầu Việt Nam</title>
        ...
        <div class="w-full container mx-auto">
            <div class="w-full flex items-center justify-between">
                <a class="flex items-center text-indigo-400 no-underline hover:no-underline font-bold text-2xl lg:text-4xl"
                    href="#">
                    Hải<span
                        class="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500">-Phong</span>
                </a>

                <div class="flex w-1/2 justify-end content-center space-x-5">
            ...
            <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
                ...
                <form class="bg-gray-900 opacity-75 w-full shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4">
                    <div class="mb-4 space-y-10">
                        ...
                        <span
                            class="text-3xl bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500"
                            for="emailaddress">
                            Signup for FUN
                        </span>
          ...
          <div class="flex w-full justify-center md:justify-start pb-24 lg:pb-0 fade-in">
            ...
            <div class="w-full pt-16 pb-6 text-sm text-center md:text-left fade-in">
                ...
                <a class="text-gray-500 no-underline hover:no-underline"
                    href="https://www.facebook.com/phongdev25/">Phong</a>
            </div>
        </div>
    </div>
</body>
